...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_spec_map[] = {
    ...
    LV_KEYBOARD_CTRL_BTN_FLAGS | 2, LV_KB_BTN(2), LV_KB_BTN(2), LV_KB_BTN(2), LV_KB_BTN(2), LV_BTNMATRIX_CTRL_CHECKED | 2, 6, LV_BTNMATRIX_CTRL_CHECKED | 2, LV_KEYBOARD_CTRL_BTN_FLAGS | 2
};
